...
var ColumnDisplayNames = map[string]string{
	...
	"Kommentar":             "Kommentar",
	"BewirtungAnlass":       "Bewirtung Anlass",
	"BewirtungTeilnehmer":   "Bewirtung Teilnehmer",
	"BewirtungAufBeleg":     "Bewirtung Angaben auf Beleg",
...
var ColumnTranslationKeys = map[string]string{
	...
	"Ausgangsrechnung":      "table.col.ausgangsrechnung",
	"Kommentar":             "table.col.comment",
	"BewirtungAnlass":       "table.col.bewirtunganlass",
	"BewirtungTeilnehmer":   "table.col.bewirtungteilnehmer",
	"BewirtungAufBeleg":     "table.col.bewirtungaufbeleg",
	"BetragNetto_EUR":       "table.col.net_eur",
	"Gebuehr":               "table.col.fee",
	"Rabatt":                "table.col.rabatt",
...
func (r *CSVRepository) Load(path string) ([]CSVRow, error) {
	...
	for i := start; i < len(records); i++ {
		...
		row := CSVRow{
			...
			Ausgangsrechnung:         parseBool(valueForColumn(record, headerMap, "Ausgangsrechnung")),
			Kommentar:                valueForColumn(record, headerMap, "Kommentar"),
			BewirtungAnlass:          valueForColumn(record, headerMap, "BewirtungAnlass"),
			BewirtungTeilnehmer:      valueForColumn(record, headerMap, "BewirtungTeilnehmer"),
			BewirtungAngabenAufBeleg: parseBool(valueForColumn(record, headerMap, "BewirtungAufBeleg")),
			...
			Rabatt:                   parseFloat(valueForColumn(record, headerMap, "Rabatt")),
...
func (r *CSVRepository) rowToRecord(row CSVRow) []string {
	...
	valueMap := map[string]string{
		...
		"Ausgangsrechnung":      formatBool(row.Ausgangsrechnung),
		"Kommentar":             row.Kommentar,
		"BewirtungAnlass":       row.BewirtungAnlass,
		"BewirtungTeilnehmer":   row.BewirtungTeilnehmer,
		"BewirtungAufBeleg":     formatBool(row.BewirtungAngabenAufBeleg),
		"BetragNetto_EUR":       r.formatFloat(row.BetragNetto_EUR),
		"Gebuehr":               r.formatFloat(row.Gebuehr),
		"Rabatt":                r.formatFloat(row.Rabatt),
